...
const tokenizeHTML = require("./erb-tokenizer.js");
const encodeExpressions = require("./erb-encoder.js");
...
function createParser({
  ...
  return {
    parse: (text, parsers, options) => {
      ...
      const [encodedText, expressionMap] = encodeExpressions(tokens);
      options.expressionMap = expressionMap
      // TOOD: formatting in embed I think

      return _parse(encodedText, options, {
        recognizeSelfClosing,
        normalizeTagName,
        normalizeAttributeName,
        allowHtmComponentClosingTags,
